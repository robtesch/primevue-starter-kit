    ...
    <div class="flex min-h-screen flex-col items-center bg-[#FDFDFC] p-6 text-[#1b1b18] lg:justify-center lg:p-8 dark:bg-[#0a0a0a]">
        <header class="mb-6 w-full max-w-[335px] text-sm not-has-[nav]:hidden lg:max-w-4xl">
            <nav class="flex items-center justify-end gap-4">
                <!-- @vue-ignore href is allowed when rendering as "i-link" tag -->
                <Button v-if="page.props.auth.user" as="i-link" :href="route('dashboard')" outlined size="small"> Dashboard </Button>
                <template v-else>
                    <!-- @vue-ignore href is allowed when rendering as "i-link" tag -->
                    <Button as="i-link" text :href="route('login')" size="small"> Log in </Button>
                    <!-- @vue-ignore href is allowed when rendering as "i-link" tag -->
                    <Button as="i-link" :href="route('register')" size="small"> Register </Button>
                </template>
            </nav>
        </header>
        <div class="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
            <Card>
                <template #header>
                    <div
                        class="relative aspect-335/376 w-full shrink-0 overflow-hidden rounded-t-lg bg-[#fff2f2] lg:mb-0 lg:aspect-auto dark:bg-[#1D0002]"
                    >
                        <svg
                ...
                <template #footer>
                    <!-- @vue-ignore href is allowed when rendering as "a" tag -->
                    <Button as="a" href="https://cloud.laravel.com" target="_blank" size="small"> Deploy now </Button>
                </template>
            </Card>
        </div>
